...
def atualizar(lista_nomes):
    ...
    if nome_antigo in lista_nomes:
        novo_nome = input(f"Digite o novo nome para {antigo_nome} : ")
        indice = lista.nomes.index(nome_antigo)
...
nomes = []  #   Criando uma lista

#   Menu
while True:
    print("= Grenciador de nomes =")
    print("1 - Adicionar")
    print("2 - Listar nomes")
    print("3 - Atualizar")
    print("4 - Excluir")
    print("5 - Desligar o programa")
    print()
